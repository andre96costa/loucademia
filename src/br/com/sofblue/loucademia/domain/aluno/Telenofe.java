package br.com.sofblue.loucademia.domain.aluno;
...
@Embeddable
public class Telenofe implements Serializable {
	...
	public String toString() {
		return "Telenofe [dddCelular=" + dddCelular + ", numeroCelular=" + numeroCelular + ", dddFixo=" + dddFixo
