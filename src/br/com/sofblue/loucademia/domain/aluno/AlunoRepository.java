...
public class AlunoRepository {
	...
	public String gerMaxMatriculaAno() {
	...
	public List<Aluno> lisAlunos(String matricula, String nome, Integer rg, Integer telefone){
	...
	public List<Acesso> listAcessosAlunos(String matricula, LocalDate dataInicial, LocalDate dataFinal){
		...
		if(dataFinal != null) {
			jpql.append(" a.entrada <= :saidaFim AND ");
		}
